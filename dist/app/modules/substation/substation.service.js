...
const getDataById = (substationCode) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateIntoDB = (substationCode, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.substation.update({
        where: {
            substationCode: substationCode,
        },
        data: payload,
