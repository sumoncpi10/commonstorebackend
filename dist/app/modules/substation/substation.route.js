...
router.get('/', substation_controller_1.SubstationController.getAllFromDB);
router.get('/:substationCode', substation_controller_1.SubstationController.getDataById);
