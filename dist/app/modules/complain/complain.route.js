...
router.get('/:pbsCode', complain_controller_1.ComplainController.getAllFromDB);
router.get('complain/:complainCode', complain_controller_1.ComplainController.getDataById);
