...
const inertIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = prisma_1.default.complainCenter.create({
        data: data,
    });
    return result;
});
const getAllFromDB = (filters, options, pbsCode) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: complain_constrant_1.complainSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
    ...
    const result = yield prisma_1.default.complainCenter.findMany({
    ...
    const total = yield prisma_1.default.complainCenter.count();
    return {
        meta: {
            total,
            page,
